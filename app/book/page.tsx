        ...
        <div className="max-w-lg mx-auto">
          ...
          <form action={formAction} className="bg-white rounded-2xl shadow-md p-6 space-y-5">
            ...
            <div>
              ...
              <select id="service_type" name="service_type" required defaultValue="" className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white">
            ...
            <button type="submit" disabled={isPending} className="w-full bg-red-600 text-white rounded-lg py-3 font-bold text-sm hover:bg-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
